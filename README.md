...
2. Create a new Tab - Leave it as Sheet2
3.  Go to Tools > Script-Editor
4.  Replace the code in Code.gs with the below:
...
5. Name the Script >> Save the script (floppy disk button) >> Run the Script (play button) >> Accept all the permissions.
